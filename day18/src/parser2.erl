...
-file("src/parser2.yrl", 18).

unwrap({_,_,V}) -> V.

-file("/usr/local/Cellar/erlang/23.1.5/lib/erlang/lib/parsetools-2.2/include/yeccpre.hrl", 0).
%%
%% %CopyrightBegin%
%%
...
yeccpars2_3(_S, '$end', _Ss, Stack, _T, _Ts, _Tzr) ->
 {ok, hd(Stack)};
yeccpars2_3(S, mult, Ss, Stack, T, Ts, Tzr) ->
...
yeccpars2_6(S, mult, Ss, Stack, T, Ts, Tzr) ->
 yeccpars1(S, 7, Ss, Stack, T, Ts, Tzr);
yeccpars2_6(S, rparen, Ss, Stack, T, Ts, Tzr) ->
